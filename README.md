...
本仓库在上游 RuoYi 说明之外维护了二次开发、审计、工程实践和实习生培训文档。请从 **[docs/README.md](./docs/README.md)** 进入，先确认内容属于当前实现、审计快照、操作指南还是规划任务。

| 入口 | 内容 | 状态 |
| :--- | :--- | :--- |
| [项目上下文](./CONTEXT.md) | 当前系统边界、模块、身份权限与稳定术语 | 当前实现 |
| [代码库审计](./docs/audit/README.md) | 架构、前端、安全证据与整改路线 | 2026-07-21 审计快照 / 规划 |
| [工程指南](./docs/guides/README.md) | 研发、迁移、测试、CI、发布、运维、Swagger | 当前约定 + 目标模板 |
| [实习生带教](./docs/intern/README.md) | 学习路径、环境清单、模块地图与 W1-W12 任务书 | 培训体系 |

> 根 README 的“内置功能”描述当前上游系统能力；W8-W12 等任务书描述待实现的训练目标，不代表工单、测试流水线或容器部署已经存在。
