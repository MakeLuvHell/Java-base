...
4. tasks/W1-login-and-user-list.md  ← 第 1 周唯一任务书
5. （W1 通过后）tasks/W2-notice-enhancement.md  ← 第 2 周
```

**口诀：** 第 1 周跟链路，第 2 周做小闭环，第 3 周加深权限/质量，第 4 周 Demo 收口。  
...
| [W2-notice-enhancement.md](./tasks/W2-notice-enhancement.md) | 第 2 周 | 通知公告置顶（垂直切片） | **仅 W1 通过后** |

第 3～4 周从 [04-task-pool.md](./04-task-pool.md) 选题，用 [03-task-template.md](./03-task-template.md) 写成完整任务书再下达。
